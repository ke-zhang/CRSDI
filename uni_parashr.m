function [a1,a2,a3,b1,b2,b3,c1,c2,c3]=uni_parashr(x,y,z) 
% Calculate the parameters of the Marginal distribution function that best fit the three variables of the shrubland.
