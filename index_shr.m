function [DI]=index_shr(data,scale)
% Calculate the comprehensive remote sensing drought index (CRSDI) of shrubland
% data is the data of three variables of shrubland, the first is precipitation, the second is enhanced vegetation index (EVI), the third is land surface temperature (LST); scale is time scale.
P=data(:,1);
E=data(:,2);
L=data(:,3);
P1=[]; L1=[]; E1=[];
